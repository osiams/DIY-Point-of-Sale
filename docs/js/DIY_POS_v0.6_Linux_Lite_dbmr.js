...
let img=[
	...
	"pos_linux_lite_v0.6_mrdb06.png",
		"เปิดไฟล์ /opt/lampp/phpmyadmin/config.inc.php แก้ไข <br>$cfg['Servers'][$i]['auth_type'] = 'config';<br>เป็น<code class=\"block\">$cfg['Servers'][$i]['auth_type'] = 'cookie';</code>",
